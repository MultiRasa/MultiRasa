          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-4 site-animate">
                <h2 class="site-heading-2">FATIMAH Cake & Bakery</h2>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.min.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/popper.min.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.easing.1.3.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.waypoints.min.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/owl.carousel.min.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.magnific-popup.min.js"></script>

    <script src="<?php echo base_url ();?>assets/pelanggan/js/bootstrap-datepicker.js"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.timepicker.min.js"></script>
    
    <script src="<?php echo base_url ();?>assets/pelanggan/js/jquery.animateNumber.min.js"></script>
    

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
    <script src="<?php echo base_url ();?>assets/pelanggan/js/google-map.js"></script>

    <script src="<?php echo base_url ();?>assets/pelanggan/js/main.js"></script>
