  ...
  <main class="app-content">
     <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Tambah Data Karyawan</a></li>
        </ul>
      </div>
      <center>
<b><h2>Data Karyawan</h2></b><hr>
 <table border="0" width="600px">
             <form action="create" method="post">
                <tr>
                    <td><?php echo $model->labels['nama_karyawan']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="nama_karyawan" size="30" maxlength="50" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><?php echo $model->labels['alamat']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="alamat" size="30" maxlength="10" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><?php echo $model->labels['jk']; ?></td>
                    <td>:</td>
                    <td><select name="jk" maxlength="50" ><option value="L">Laki-laki</option><option value="P">Perempuan</option><</select></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                ...
                <td></td>
                <td></td>
                <td><input  style="color: white;" type="submit" class="btn btn-primary" name="btnSubmit" value="SIMPAN"/>&nbsp;&nbsp;&nbsp;
                <input style="color: white;" type="button" class="btn btn-danger" name="Batal" value="BATAL" onclick="javascript:history.go(-1);"/>
</b>
                </td>
            </tr>
</form>
