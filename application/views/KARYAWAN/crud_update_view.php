...
<main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Ubah Data Karyawan</a></li>
        </ul>
      </div>
 <center>
            <center>
<b><h2 >Data Karyawan</h2></b><hr>
            ...
            <form action="create" method="POST">
                <tr>
                    <td><b><?php echo $model->labels['id_karyawan']; ?></b></td>
                    <td>:</td>
                    <td><b><input readonly type="text" name="id_karyawan" size="30" maxlength="30" value="<?php echo $model->id_karyawan; ?>" /></b></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['nama_karyawan']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="nama_karyawan" size="30" maxlength="30" value="<?php echo $model->nama_karyawan; ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="alamat" size="30" maxlength="30" value="<?php echo $model->alamat; ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td> <input type="level" name="jk" size="30" maxlength="30" value="<?php echo $model->jk; ?>" /></td>
                </tr>
               <tr>
                    <td></td>
                    <td></td>
