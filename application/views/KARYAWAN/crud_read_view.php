        ...
        <nav class="navbar navbar-expand-sm navbar-default"> 
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li >
                        <a href="<?php echo base_url()?>LoginAdmin/index"><i class="app-menu__icon fa fa-laptop"></i>&nbsp;&nbsp;<b>BERANDA</b> </a>
                    </li>
...
<center>
<b><h2>Data Karyawan</h2></b><br>
             <p><b><a href="<?php echo base_url()?>Karyawan/create" class="btn btn-success"><span class="fa fa-user fa-lg"></span> Tambah</a></b></p>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a style="color: #0984e3" href="<?php echo base_url()?>Karyawan/update/<?php echo $row->id_karyawan; ?>"><span class="fa fa-edit fa-lg" ></span></a></td>
        <td><a style="color: #d63031" href="<?php echo base_url()?>Karyawan/delete/<?php echo $row->id_karyawan;  ?>"><span class="fa fa-trash fa-lg" ></span></a></td>
    </tr>
    <?php
}
?>
