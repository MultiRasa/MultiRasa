 ...
 <main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Data Roti</a></li>
        </ul>
      </div>
<center>
<b><h2>Data Roti</h2></b><br>
<p><b><a href="<?php echo base_url()?>Roti/input" class="btn btn-success"><span class="fa fa-user fa-lg"></span> Tambah</a></b></p> <br> 
    <button><a href="<?php echo base_url()?>Roti/index/1">Kue Manis</a></button>
    <button><a href="<?php echo base_url()?>Roti/index/2">Kue Gurih</a></button>
    <button><a href="<?php echo base_url()?>Roti/index/3">Tart</a></button>
    <button><a href="<?php echo base_url()?>Roti/index/4">Kue Basah</a></button><br><br>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a style="color: #0984e3" href="<?php echo base_url()?>Roti/update/<?php echo $row->id_roti; ?>"><span class="fa fa-edit fa-lg" ></span></a></td>
        <td><a style="color: #d63031" href="<?php echo base_url()?>Roti/delete/<?php echo $row->id_roti;  ?>"><span class="fa fa-trash fa-lg" ></span></a></td>
    </tr>
    <?php
}
?>
