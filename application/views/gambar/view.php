            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li ><a><b><i class="app-menu__icon fa fa-credit-card"></i>&nbsp;&nbsp;TRANSAKSI</b></a></li>
                            <li ><i class="fa fa-circle">&nbsp;&nbsp;<a href="<?php echo base_url()?>Karyawan/index">Tabel Transaksi</a></i></li>
                    ...
                    <li ><a href=""><b><i class="app-menu__icon fa fa-file-image-o"></i>&nbsp;&nbsp;GALERI</b></a></li>  
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    </aside><!-- /#left-panel --> 
 ...
 <main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Gambar</a></li>
        </ul>
      </div>
<center>
<b><h2>Galeri</h2></b><br>
             <p><b><a href="<?php echo base_url()?>Gambar/tambah" class="btn btn-success"><span class="fa fa-user fa-lg"></span> Tambah</a></b></p>
...
if( ! empty($gambar)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
  foreach($gambar as $data){ // Lakukan looping pada variabel gambar dari controller
    echo "<tr>";
    echo "<td><img src='".base_url("images/".$data->nama)."' width='100' height='100'></td>";
    echo "<td>".$data->nama."</td>";
    echo "<td>".$data->ukuran." kB</td>";
