...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a style="color: #d63031" href="<?php echo base_url()?>Komentar/delete/<?php echo $row->id_komentar;  ?>"><span class="fa fa-trash fa-lg" ></span></a></td>
    </tr>
    <?php
}
?>
