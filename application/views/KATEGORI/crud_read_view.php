...
<center>
<b><h2 >Data Kategori</h2></b><br>
             <p><b><a href="<?php echo base_url()?>Kategori/create" class="btn btn-success"><span class="fa fa-user fa-lg"></span> Tambah</a></b></p>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td><a style="color: #d63031" href="<?php echo base_url()?>Kategori/delete/<?php echo $row->id_kategori;  ?>"><span class="fa fa-trash fa-lg" ></span></a></td>
    </tr>
    <?php
}
?>
