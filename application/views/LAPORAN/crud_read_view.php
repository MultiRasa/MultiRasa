...
<center>
<b><h2>LAPORAN</h2></b><br>
      <button data-toggle="modal" data-target="#lapHarian" style="color: black">HARI INI</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button data-toggle="modal" data-target="#lapBulan" style="color: black">PILIH TANGGAL</button>
 <div id="lapBulan" class="modal fade" role="dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" target="_blank" action="">
            <table>
              <tr>
                <td>Tanggal Awal : </td><td><input type="date" name="tglAwal" id="tglAwal"></td>
              
              </tr>
              <tr>
                <td>Tanggal Akhir : </td><td><input type="date" name="tglAkhir" id="tglAkhir"></td>
              </tr>
            </table><br>
            <input type="submit" name="rekap" value="REKAP">
          </form>
        </div>
      </div>
    </div>
